...
- [3. Beyond SVG]({{ site.baseurl }}/chapter03/index.html)
...
- [7. Creating a Charting Package]({{site.baseurl}}/chapter07)
...
- [8. Deploying the Visualization]({{site.baseurl}}/chapter08)
...
- [9. Creating a Dashboard]({{ site.baseurl }}/chapter09)
    ...
    - [9.5 Class]({{ site.baseurl }}/chapter09/05-class)
